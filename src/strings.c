...
const u8 gText_MenuSafariStats[] = _("BALLS  {STR_VAR_3}");
...
const u8 gText_PlayerUsedVar3[] = _("{PLAYER} used the\n{STR_VAR_2}.");
...
const u8 gText_50Coins_500[] = _("{FONT_SMALL}50 COINS{CLEAR_TO 0x50}¥500");
const u8 gText_500Coins_5000[] = _("{FONT_SMALL}500 COINS{CLEAR_TO 0x46}¥5,000");
